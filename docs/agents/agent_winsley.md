...
**Quick Reference Cheat Sheet:** `@vader-ai-agents/docs/agents/_cheatsheet_winsley.md`  
...
- **Winsley → Crystal**
  ...
  - In your **"For the Next Agent"** section, write a prompt addressed to Crystal that:
    ...
    - **Includes reference to Crystal's instruction file**: `Please read your agent instructions at @vader-ai-agents/docs/agents/agent_crystal.md`
